                                    ...
                                    <div className="row">
                                        <div className="col col-lg-5 slide-caption">
                                            <div className="slide-title">
                                                <h2><span>Bánh</span> Ngọt <span>Thơm Ngon</span></h2>
                                            </div>
                                            <div className="btns">
                                                <Link to="/shop" className="btn theme-btn">Đặt hàng <i className="fa fa-angle-double-right"></i></Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="slide-inner" style={{ backgroundImage: `url(${hero2})` }}>
                                <div className="container">
                                    <div className="row">
                                        <div className="col col-lg-5 slide-caption">
                                            <div className="slide-title">
                                                <h2><span>Bánh</span> Mặn <span>Đậm Đà</span></h2>
                                            </div>
                                            <div className="btns">
                                                <Link to="/shop" className="btn theme-btn">Đặt hàng <i className="fa fa-angle-double-right"></i></Link>
                                            </div>
                            ...
                            <div className="slide-inner" style={{ backgroundImage: `url(${hero3})` }}>
                                <div className="container">
                                    <div className="row">
                                        <div className="col col-lg-5 slide-caption">
                                            <div className="slide-title">
                                                <h2><span>Bánh</span> Kem <span>Tươi Mát</span></h2>
                                            </div>
                                            <div className="btns">
                                                <Link to="/shop" className="btn theme-btn">Đặt hàng <i className="fa fa-angle-double-right"></i></Link>
                                            </div>
