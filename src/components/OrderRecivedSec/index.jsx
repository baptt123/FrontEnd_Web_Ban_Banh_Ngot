                                            ...
                                            <TableBody>
                                                {cartList.map(item => (
                                                    <TableRow key={item.id}>
                                                        <TableCell><img src={item.proImg} alt="" /> {item.title} {Number(item.price).toLocaleString('vi-VN')}₫ x {item.qty}</TableCell>
                                                        <TableCell
                                                ...
                                                <TableRow>
                                                    ...
                                                    <TableCell
                                                        align="right"><b>{Number(totalPrice(cartList)).toLocaleString('vi-VN')}₫</b></TableCell>
                                                </TableRow>
                                            </TableBody>
                                        </Table>
                                    </Grid>
