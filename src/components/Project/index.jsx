            ...
            <section id="protfolio" className="tp-projects section-padding">
                <div className="container">
                    <div className="row">
                        <div className="col col-xs-12 sortable-gallery">
                            <div className="section-title mb-0">
                                <h2>Bộ Sưu Tập <span>Bánh</span></h2>
                            </div>
                            <div className="projects-menu">
                                <ul>
                                    <li><Link data-filter="*" to="/" className="current" onClick={allElement}>Tất Cả</Link></li>
                                    <li><Link data-filter=".Web-Design" to="/" onClick={webDesign}>Bánh Ngọt</Link></li>
                                    <li><Link data-filter=".Print-Design" to="/" onClick={printDesign}>Bánh Mặn</Link></li>
                                    <li><Link data-filter=".Web-Application" to="/" onClick={webApp}>Bánh Kem</Link></li>               
                                    <li><Link data-filter=".Photography" to="/" onClick={Photography}>Bánh Đặc Biệt</Link></li> 
                                </ul>
                            </div>
                            <div className="gallery-container gallery-fancybox masonry-gallery payra-masonary">
                                    ...
                                    <div className="project-inner">
                                        ...
                                        <div className="hover-content">
                                            <div className="details">
                                                <h3><Link onClick={ClickHandler} to="/project-single">Bánh Sinh Nhật</Link></h3>
                                                <p className="cat">Bánh Kem</p>
                                            </div>
                                        </div>
                                    </div>      
                                </div>
                                <div className={this.state.Flower ? "grid active" : "grid" 
                                    ...
                                    <div className="project-inner">
                                        ...
                                        <div className="hover-content">
                                            <div className="details">
                                                <h3><Link onClick={ClickHandler} to="/project-single">Bánh Cupcake</Link></h3>
                                                <p className="cat">Bánh Ngọt</p>
                                            </div>
                                        </div>
                                    </div> 
                                ...
                                <div className={this.state.Forest ? "grid active" : "grid"
                                    ...
                                    <div className="project-inner">
                                        ...
                                        <div className="hover-content">
                                            <div className="details">
                                                <h3><Link onClick={ClickHandler} to="/project-single">Bánh Pizza</Link></h3>
                                                <p className="cat">Bánh Mặn</p>
                                            </div>
                                        </div>
                                    </div> 
                                </div>
                                <div className={this.state.Hill ? "grid active" : "grid"
                                    ...
                                    <div className="project-inner">
                                        ...
                                        <div className="hover-content">
                                            <div className="details">
                                                <h3><Link onClick={ClickHandler} to="/project-single">Bánh Tart</Link></h3>
                                                <p className="cat">Bánh Ngọt</p>
                                            </div>
                                        </div>
                                    </div> 
                                ...
                                <div className={this.state.Hill ? "grid active" : "grid"
                                    ...
                                    <div className="project-inner">
                                        ...
                                        <div className="hover-content">
                                            <div className="details">
                                                <h3><Link onClick={ClickHandler} to="/project-single">Bánh Mousse</Link></h3>
                                                <p className="cat">Bánh Kem</p>
                                            </div>
                                        </div>
                                    </div> 
                                ...
                                <div className={this.state.Hill ? "grid active" : "grid"
                                    ...
                                    <div className="project-inner">
                                        ...
                                        <div className="hover-content">
                                            <div className="details">
                                                <h3><Link onClick={ClickHandler} to="/project-single">Bánh Tiramisu</Link></h3>
                                                <p className="cat">Bánh Đặc Biệt</p>
                                            </div>
                                        </div>
                                    </div> 
                                </div>
                                <div className={this.state.Hill ? "grid active" : "grid"
                                    ...
                                    <div className="project-inner">
                                        ...
                                        <div className="hover-content">
                                            <div className="details">
                                                <h3><Link onClick={ClickHandler} to="/project-single">Bánh Macaron</Link></h3>
                                                <p className="cat">Bánh Ngọt</p>
                                            </div>
                                        </div>
                                    </div> 
                                ...
                                <div className={this.state.Flower ? "grid active" : "grid"
                                    ...
                                    <div className="project-inner">
                                        ...
                                        <div className="hover-content">
                                            <div className="details">
                                                <h3><Link onClick={ClickHandler} to="/project-single">Bánh Croissant</Link></h3>
                                                <p className="cat">Bánh Mặn</p>
                                            </div>
                                        </div>
                                    </div> 
                                ...
                                <div className={this.state.Flower ? "grid active" : "grid"
                                    ...
                                    <div className="project-inner">
                                        ...
                                        <div className="hover-content">
                                            <div className="details">
                                                <h3><Link onClick={ClickHandler} to="/project-single">Bánh Opera</Link></h3>
                                                <p className="cat">Bánh Đặc Biệt</p>
                                            </div>
                                        </div>
                                    </div> 
                    ...
                    <div className="view-btn">
                        <Link  onClick={ClickHandler} className="theme-btn" to="/project">Xem Tất Cả <i className="fa fa-angle-double-right"></i></Link>
                    </div>
                </div>
            </section>
        );
