...
// PayPal Button Component được tích hợp trực tiếp
const PaypalButton = () => {
    ...
    React.useEffect(() => {
        ...
        // Load PayPal SDK script với error handling tốt hơn
    ...
    return (
        <div style={{ maxWidth: "100%", marginTop: "20px" }}>
            {!isScriptLoaded && <div>Loading PayPal...</div>}
                            ...
                            <Grid className="cuponWrap checkoutCard">
                                ...
                                <Grid className="chCardBody">
                                    <Collapse in={tabs.payment} timeout="auto">
                                        ...
                                        {/* Thêm PayPal Button */}
                                        <Collapse in={forms.payment_method === 'paypal'} timeout="auto">
                                            <Grid className="paypalSection">
                                                <PaypalButton />
                                            </Grid>
                                        </Collapse>
                                    </Collapse>
